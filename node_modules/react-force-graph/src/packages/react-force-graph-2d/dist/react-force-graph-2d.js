// Version 1.6.1 react-force-graph-2d - https://github.com/vasturiano/react-force-graph
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react')) :
  typeof define === 'function' && define.amd ? define(['react'], factory) :
  (global = global || self, global.ForceGraph2D = factory(global.React));
  ...
  **/
  ...
  var CanvasForceGraph = Kapsule({
      ...
      tickFrame: function tickFrame(state) {
        ...
        function paintArrows() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints && _construct(bezierJs, [start.x, start.y].concat(_toConsumableArray$1(link.__controlPoints), [end.x, end.y]));
        ...
        function paintPhotons() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints ? _construct(bezierJs, [start.x, start.y].concat(_toConsumableArray$1(link.__controlPoints), [end.x, end.y])) : null;
    ...
    update: function update(state) {
      ...
      state.graphData.links.forEach(function (link) {
        ...
        if (numPhotons) {
          link.__photons = _toConsumableArray$1(Array(numPhotons)).map(function () {
            return {};
          });
        }
  ...
  var linkedProps = Object.assign.apply(Object, _toConsumableArray$1(['nodeColor', 'nodeAutoColorBy', 'nodeCanvasObject', 'linkColor', 'linkAutoColorBy', 'linkWidth', 'linkCanvasObject', 'linkDirectionalArrowLength', 'linkDirectionalArrowColor', 'linkDirectionalArrowRelPos', 'linkDirectionalParticles', 'linkDirectionalParticleSpeed', 'linkDirectionalParticleWidth', 'linkDirectionalParticleColor', 'dagMode', 'dagLevelDistance', 'd3AlphaDecay', 'd3VelocityDecay', 'warmupTicks', 'cooldownTicks', 'cooldownTime', 'onEngineTick', 'onEngineStop'].map(function (p) {
    return _defineProperty$1({}, p, bindFG.linkProp(p));
  })).concat(_toConsumableArray$1(['nodeRelSize', 'nodeId', 'nodeVal', 'linkSource', 'linkTarget', 'linkVisibility', 'linkCurvature'].map(function (p) {
    return _defineProperty$1({}, p, bindBoth.linkProp(p));
  }))));
  var linkedMethods = Object.assign.apply(Object, _toConsumableArray$1(['d3Force', 'refresh'].map(function (p) {
  ...
  */
  ...
  const ForceGraph2D = index(forceGraph, undefined, [// bind methods
