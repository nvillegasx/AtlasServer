...
var ForceGraphVRKapsule = _interopDefault(require('3d-force-graph-vr'));
...
const ForceGraphVR = fromKapsule(ForceGraphVRKapsule, undefined, [// bind methods
'd3Force', 'refresh']);
ForceGraphVR.displayName = 'ForceGraphVR';
ForceGraphVR.propTypes = ForceGraphVRPropTypes;

const ForceGraph3D = fromKapsule(ForceGraph3DKapsule, undefined, [// bind methods
'd3Force', 'stopAnimation', 'pauseAnimation', 'resumeAnimation', 'cameraPosition', 'scene', 'camera', 'renderer', 'controls', 'refresh'], ['controlType', 'rendererConfig']);
ForceGraph3D.displayName = 'ForceGraph3D';
ForceGraph3D.propTypes = ForceGraph3DPropTypes;

const ForceGraph2D = fromKapsule(ForceGraph2DKapsule, undefined, [// bind methods
